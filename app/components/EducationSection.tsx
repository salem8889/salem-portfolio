    ...
    <section id="education" className="py-24 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {/* Degree Card */}
          <div className="glow-card p-6 sm:p-8 rounded-3xl bg-white border border-black/10 shadow-sm flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between gap-2 mb-4">
                <span className="text-xs font-bold uppercase tracking-wider text-zinc-500">
                  {t.education.degree.type}
                </span>
                <span className="px-3 py-1 rounded-full bg-zinc-100 text-zinc-900 text-xs font-bold border border-black/10">
            ...
            <div className="mt-6 pt-4 border-t border-black/10 flex items-center gap-2 text-xs font-semibold text-zinc-800">
          ...
          <div className="glow-card p-6 sm:p-8 rounded-3xl bg-white border border-black/10 shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-6 pt-4 border-t border-black/10 flex items-center justify-between text-xs">
              ...
              <span className="text-zinc-500">Satr Platform</span>
            </div>
          </div>
        </div>

        {/* Languages Banner */}
        <div className="rounded-2xl bg-zinc-50 border border-black/10 p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
          ...
          <div className="flex items-center gap-3">
            <div className="px-5 py-2.5 rounded-xl bg-white border border-black/10 shadow-xs text-center">
              <span className="block font-heading text-sm font-bold text-zinc-950">
